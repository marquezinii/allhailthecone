<p align="center">
  <img src="public/brand/cone-mark.svg" width="112" alt="The Sacred Cone mark" />
</p>
...
<p align="center">
  <a href="https://github.com/marquezinii/allhailthecone/actions/workflows/ci.yml"><img src="https://github.com/marquezinii/allhailthecone/actions/workflows/ci.yml/badge.svg" alt="Verify the archive" /></a>
  <a href="https://allhailthecone.com"><img src="https://img.shields.io/badge/official_archive-allhailthecone.com-F2A836?labelColor=10131D" alt="Official archive" /></a>
  <a href="https://discord.gg/9VyUNRk7N"><img src="https://img.shields.io/badge/community-Discord-9472D1?labelColor=10131D" alt="Official Discord" /></a>
  <a href="https://github.com/marquezinii/allhailthecone/releases/tag/v1.0.0"><img src="https://img.shields.io/badge/release-v1.0.0-9472D1?labelColor=10131D" alt="First Edition release" /></a>
</p>
...
![The First Observance — the founding visual reference for All Hail the Cone](public/art/the-first-observance-960.webp)
...
```mermaid
flowchart LR
  A[Root canon Markdown] --> D[Astro pages]
  B[Typed universe and gallery data] --> D
  C[Localized content and interface copy] --> D
  E[Original art plus provenance] --> F[Asset preparation]
  F --> G[Optimized public WebP catalog]
  G --> D
  D --> H[Static HTML archive]
  H --> I[Browser: core archive]
  H --> J[Visible-only Sacred Cone island]
  J --> K[React Three Fiber + Three.js + GSAP]
```
