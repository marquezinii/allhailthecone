...
export const commonCopy = {
  en: {
    ...
    support: "Support the archive on Ko-fi",
  ...
  pt: {
    ...
    support: "Apoiar o arquivo no Ko-fi",
  ...
  de: {
    ...
    support: "Archiv auf Ko-fi unterstützen",
  ...
  fr: {
    ...
    support: "Soutenir les archives sur Ko-fi",
